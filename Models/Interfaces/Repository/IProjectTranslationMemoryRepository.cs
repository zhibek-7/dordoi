...
namespace Models.Interfaces.Repository
{
    public interface IProjectTranslationMemoryRepository
    {
        ...
        /// <returns></returns>
        Task<IEnumerable<ProjectTranslationMemory>> GetByProject(int idProject);
        ...
        /// <returns></returns>
        Task<bool> UpdateProjectTranslationMemories(int idProject, int[] idTranslationMemories, bool isDeleteOldRecords = true);
        ...
        /// <param name="isDeleteOldRecords">Удалить старые записи.</param>
        /// <returns></returns>
        Task<bool> UpdateTranslationMemoriesLocalizationProjectsAsync(int userId, int translationMemoryId, IEnumerable<int?> localizationProjectsIds, bool isDeleteOldRecords = true);
    }
}
